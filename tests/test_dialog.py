...
def test_choice_flag_gating():
    ...
    dialog = {
        ...
        "choices": [
            {
                "text": "A",
                "require_flags": ["knows_village_burns"],
                "set_flags": [],
                "next": None,
            },
            {
...
def test_choice_require_not_flags_blocks():
    ...
    dialog = {
        ...
        "choices": [
            {
                "text": "A",
                "require_not_flags": ["already_spoken"],
                "set_flags": [],
                "next": None,
            },
...
def test_choice_reputation_gate():
    ...
    dialog = {
        ...
        "choices": [
            {
                "text": "A",
                "require_reputation": {"merchant_guild": 20},
                "set_flags": [],
                "next": None,
            },
            {
                "text": "B",
                "require_reputation": {"merchant_guild": 10},
                "set_flags": [],
                "next": None,
            },
        ],
        ...
        "choices": [
            {
                "text": "A",
                "require_flags": [],
                "set_flags": ["met_old_man"],
                "next": "dialog_old_man_1",
            }
        ],
    }
